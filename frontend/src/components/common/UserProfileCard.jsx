    ...
    return (
        <div className='bg-white rounded-lg border border-blue-300/70 flex flex-col min-h-full min-w-[20%] items-center  '>
            <div className='p-5 text-center relative w-full items-center justify-center'>
                ...
                <p className='capitalize font-semibold text-lg text-blue-600'>{user.role.toLowerCase()}</p>
                <p className='capitalize font-semibold text-sm text-gray-400'>{user.designation.toLowerCase()}</p>
            ...
            <div className='w-full border-t border-t-blue-300/70 py-3 px-5 flex flex-col gap-2'>
                ...
                <p className='  text-sm text-gray-400 flex items-center gap-2 lowercase'><FiCheckSquare size={14} />{formatDateTime(user.lastUpdatedAt)}</p>
            </div>
